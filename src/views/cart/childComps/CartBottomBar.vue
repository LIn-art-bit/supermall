<template>
    <div class="bottom-bar">
        <div class="check">
            <check-button :isChecked="isSelectAllGoods" @click.native="handleSelectAllGoods"/>
            <span>全选</span>
        </div>
        <div class="all-price">合计：￥{{totalPrice}}</div>
        <div class="settle-accounts">去结算（{{totalNum}}）</div>               
    </div>
</template>
...
// import {debounce} from '@/common/utils';  @click="handleSettleAccounts"
